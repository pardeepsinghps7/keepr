        ...
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.mainView}>
            ...
            <CustomInput
              ...
              onChangeText={(val) => updateState({ currentPassword: val.replace(/[^A-Za-z0-9!@#$%^&*(),.?":{}|<>]/g, '') })}
              placeholder={LABELS.currentPassword}
              secureTextEntry={secureCurrentText}
              icon={secureCurrentText ? 'eye-off-outline' : 'eye-outline'}
              iconPress={() => updateState({ secureCurrentText: !secureCurrentText })}
            />
            {/* Password */}
