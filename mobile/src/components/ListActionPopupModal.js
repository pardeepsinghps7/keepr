...
const ListActionPopupModal = ({ modalVisible, setModalVisible, selectedItem, onView, onDelete }) => {
  const { MISC } = STRINGS
      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <TouchableOpacity style={styles.modalButton} >
            ...
            <Text style={styles.modalButtonText}>{MISC.editList}</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.modalButton} onPress={onDelete}>
            ...
            <Text style={[styles.modalButtonText, { color: COLORS.red }]}>{MISC.deleteList}</Text>
          </TouchableOpacity>
...
export default ListActionPopupModal;
