...
const AddNewListModal = ({ modalVisible, setModalVisible, selectedItem, onSave }) => {
  ...
  const init = async () => {
    ...
    try {
      ...
      updateState({ listIcon: response, selectedIcon: response[0] || {} });
    ...
    >
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.cardTitle}>{MISC.addNewList}</Text>
