export const STRINGS = {
  TITLES: {
    ...
    feedback: 'Feedback',
    feedbackSubTitle: 'We value your feedback',
  },
  LABELS: {
    ...
    typeRestaurantNameToFind: 'Type the restaurant name you want to find',
    typeRestaurantExactLocation: 'Type the exact location of the restaurant',
    ...
    city:'City',
    searchCityState:'Type a city and state for the restaurant you want to find',
  ...
  BUTTONS: {
    ...
    saveItemToTheList: 'Save item to your list',
    ...
    importGoodreadsList: 'Import a Goodreads List',
    sendFeedback: 'Send Feedback',
    deleteAccount: 'Delete Account',
    confirmDeleteAccount: 'Yes, please delete my account',
  },
  MISC: {
    ...
    searchListEmptyText:'We couldn\'t find this one in ListKeepr. To add it manually, just fill out the required fields and click save item to your list.',
    tryAgain: 'Try again',
    toWatch: 'To Watch',
    watched: 'Watched',
    toRead: 'To Read',
