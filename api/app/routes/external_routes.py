...
from app.controllers.api.external.items_controller import get_item_by_id
...
from ..controllers.api.external.readcsv_controller import read_csv_api
...
@api.route('/read-csv', methods=["POST"])
def readCsvApi():
    return read_csv_api()
